    ...
    return (<AppShell>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {allTopics.map((topic) => {
            ...
            return (<Link key={topic.slug} href={`/topic/${topic.slug}`} className="group relative flex flex-col rounded-xl border border-border bg-bg-card p-5 transition-all duration-200 hover:border-border-hover hover:translate-y-[-2px]">
