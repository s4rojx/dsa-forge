...
export default function DifficultyBadge({ difficulty }: {
    ...
    return (<span className={`inline-flex items-center rounded-md border px-2 py-0.5 text-[10px] font-mono font-semibold uppercase tracking-wider ${difficultyStyles[difficulty] || difficultyStyles.medium}`}>
      {difficulty}
    </span>);
}
