...
export default function AppShell({ children }: {
    ...
    return (<div className="min-h-screen bg-bg-root">
      <Sidebar />
      ...
      <div className="lg:ml-64">
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-bg-root/95 px-6 backdrop-blur-sm">
          <div />
          <button onClick={openSearch} className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2 text-sm text-text-2 transition-colors hover:border-primary/40 hover:text-text-1">
