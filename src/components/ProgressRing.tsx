...
export default function ProgressRing({ percentage, size = 72, label, }: ProgressRingProps) {
    const strokeWidth = 4;
    ...
    return (<div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
      <svg width={size} height={size} className="-rotate-90">
        ...
        <circle cx={size / 2} cy={size / 2} r={radius} stroke="#BB4A1E" strokeWidth={strokeWidth} fill="none" strokeDasharray={circumference} strokeDashoffset={strokeDashoffset} strokeLinecap="round" className="transition-all duration-700"/>
      </svg>
